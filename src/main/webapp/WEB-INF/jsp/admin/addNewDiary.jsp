    ...
    <div class="layui-field-box" style="width: 97%">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="operationId" name="operationId" disabled="disabled"  autocomplete="off"  class="layui-input">
            </div>
        </div>
        <form class="layui-form" action="" method="get">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="fieldId" disabled="disabled"  autocomplete="off"  class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="fieldState"  autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="insectState"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form','upload'], function(){
        ...
        form.on('submit(formDemo)', function(data){
            ...
            $.ajax({
                url: '${pageContext.request.contextPath}/admin/newDiary',
                type: 'post',
